    ...
    def __init__(
        ...
        **kwargs: Any, optional
        ...
        super().__init__(
            ...
            patient_id=src_img.get('PatientID'),
            patient_name=src_img.get('PatientName'),
            patient_birth_date=src_img.get('PatientBirthDate'),
            patient_sex=src_img.get('PatientSex'),
            accession_number=src_img.get('AccessionNumber'),
            study_id=src_img.get('StudyID'),
            study_date=src_img.get('StudyDate'),
            study_time=src_img.get('StudyTime'),
